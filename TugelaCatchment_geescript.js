//Alien Map Classification of the Tugela Catchment
...
.filterDate('2023-09-20', '2023-10-11')
print(image)
...
var Tugela_Clipped= mosaic.clip(ROI);
print(Tugela_Clipped, 'Tugela_Clipped')
...
Map.addLayer(Tugela_Clipped, TrueColour, 'Sentinel Image');

// rescale image bands /10 000
var image = Tugela_Clipped.divide(10000)
...
Map.addLayer(LULC_Clipped, {min: 1, max: 18, palette: TugelaPalette}, 'classification');

// Export classification
Export.image.toDrive({
  image: LULC_Clipped,
  description: "Tugela_Classificationv2",
  scale: 10,
  crs: 'EPSG:32735',
  region: ROI,
  maxPixels: 1e13,
...
// name of the legend
var names = ['Alien_Gum','Alien_Other','Alien_Pine','Alien_Poplar','Alien_Wattle','Bare Ground','Bracken','Burnt','Dryland Agriculture','Grassland','Indigenous Bush_Other','Indigenous Bush_Vachellia','Indigenous Forest','Irrigated Agriculture','Urban','Water','Wetland'];
