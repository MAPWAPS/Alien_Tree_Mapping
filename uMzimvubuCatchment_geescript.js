//Alien Map Classification of the uMzimvubu Catchment
...
.filterDate('2023-05-15', '2023-06-30')
print(image)
...
print(image_final, 'image_indices')
...
var classifier = ee.Classifier.smileRandomForest(100).train({
  ...
  classProperty: 'ID', // call drom the training data
...
var uMzimvubuPalette= [
  ...
  'fd0618',//Pine
  '674EA7', // Poplar
  'eea2ad', //Silver Wattle
  'FFEBBE', // Bare Ground
  'FEE238', // Dryland Agriculture
  'a8a800', // Grassland 
  '6aa84f', // Indigenous Bush 
  'ccffb3', // Indgenous Bush_Leu
  '00FF00', // Indiegnous Bush_vach
  'ffff00', // Irrigated Agriculture
  '783f04', // Maize
  'b7b7b7', //Shade
  'FFFFFF', //Urban
  '0a14f9', // Water 
...
// Cluip the classifion to ROI and display it
var LULC_Clipped= classified.clip(ROI);
Map.addLayer(LULC_Clipped, {min: 1, max: 18, palette: uMzimvubuPalette}, 'classification');

//Export classification
Export.image.toDrive({
  image: LULC_Clipped,
  description: "uMzim_ClassificationFinal",
  scale: 10,
  crs: 'EPSG:32735',
  region: ROI,
  maxPixels: 1e13,
...
Export.image.toAsset({
  image: LULC_Clipped,  
  description: 'umzim_classification15082025',
  assetId: 'projects/mapwaps-umzimvubu/assets/15082025umzim_classification',  // Set your asset path
  region: ROI,  //
  crs: 'EPSG:32735',
...
var makeRow = function(color, name) {
 ...
 // name of the legend
var names = ["Alien_Black Wattle","Alien_Gum","Alien_Other","Alien_Pine","Alien_Poplar", "Alien_Silver Wattle","Bare Ground", "Dryland Agriculture", "Grassland", "Indigenous Bush Other", "Indigenous Bush_Leucosidea", "Indigneous Bush_Vachellia","Irrigated Agriculture", 
           "Maize", "Shade", "Urban", "Water", "Wetland"]
...
// var uMzim= ee.Image('projects/mapwaps-umzimvubu/assets/15082025umzim_classification');
// var LULC_Clipped= uMzim.clip(ROI);

// Add layers to the right map (classified map using the asset)
rightMap.addLayer(LULC_Clipped, {min: 1, max: 18, palette: uMzimvubuPalette}, 'Classification');
rightMap.add(legend);
