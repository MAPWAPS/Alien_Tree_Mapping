//Alien Map Classification of the Luvhuvu Catchment
...
.filterDate('2023-06-25', '2023-06-27')
print(image)
...
var Luv_Clipped= mosaic.clip(ROI);
...
print(Luv_Clipped, 'Luv_Clipped')
Map.addLayer(Luv_Clipped, TrueColour, 'Sentinel Image');
...
var Luv_Palette= [
  ...
  'fd0618',//Pine, red
  'ffcc99', //Banana
  'FFEBBE', // Bare Ground// White
  'FEE238', // Dryland AG// Yellow
  'ccffb3', //Indigenous_bush_mopane
  '6aa84f', //	Indigenous_bush_other
  '14870e', // Indigenous_forest
...
Map.addLayer(LULC_Clipped, {min: 1, max: 19, palette: Luv_Palette}, 'classification');

//Export classification
Export.image.toDrive({
  image: LULC_Clipped,
  description: "Luv_Classificationv2",
  scale: 10,
  crs: 'EPSG:32736',
  region: ROI,
  maxPixels: 1e13,
